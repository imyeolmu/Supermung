...
<section class="admin mt-4 mb-5">
		<div class="admin-container p-3">
			<h3 class="fs-4 text-center">관리자정보</h3>
			 <form class="row account-login" action="admin-info?id=${member.id}" method="post">
				<div class="col-sm-12">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input class="form-control" type="password" name="pw2" value="">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
