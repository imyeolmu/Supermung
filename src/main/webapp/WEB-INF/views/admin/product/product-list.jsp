	...
	<table class="table">
		...
		<c:forEach items="${list}" var="list">
			<tr class="text-center">
				...
				<td width="100"><c:out value="${list.pcategory_fk1}"/></td>
				<td width="100"><c:out value="${list.pcategory_fk2}"/></td>
				<td width="100"><a href="product-update" class="pro-hre"><c:out value="${list.pname}"/></a></td>
				<!-- 이미지 주소 불러오기 -->
				<td width="100"><img src="<c:out value='${list.pimage}'/>"/></td>
				<td width="100"><c:out value="${list.pcompany}"/></td>
				<td width="100"><c:out value="${list.pspec}"/></td>
				<!-- 숫자 포맷 변경 -->
				<td width="100"><fmt:formatNumber value="${list.pqty}" pattern="#,##0"/></td>
				<td width="100" ><fmt:formatNumber value="${list.price}" pattern="#,##0"/></td>
				<td width="100"><fmt:formatNumber value="${list.ppoint}" pattern="#,##0"/></td>
				<!-- <td width="100"><nobr />소개</td> -->
				<td class="checkbox" width="100"><input type="checkbox" name="RowCheck" value="${list.pnum}"></td>
