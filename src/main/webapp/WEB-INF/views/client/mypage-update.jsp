				...
				<form class="card input-form rounded shadow-sm"
					...
					<table class="container table table-borderless">
						<tbody>
							...
							<tr>
								<td>비밀번호</td>
								<td><input class="w-50  cinput" type="number" name ="pw" value="${myinfo.pw}"></td>
							</tr>
							<tr>
								<td>이름</td>
								<td>${myinfo.name}</td>
							...
							<tr>
								<td>이메일</td>
								<td><input class="w-50  cinput" type="number" name ="email" value="${myinfo.email}"></td>
							</tr>
							<tr>
								<td>전화번호</td>
								<td><input class="w-50  cinput" type="number" name ="phone" value="${myinfo.phone}"></td>
							</tr>
							<tr>
								<td>우편번호</td>
								<td><input class="w-50  cinput" type="number" name ="zipcode" value="${myinfo.zipcode}"></td>
							</tr>
							<tr>
								<td>주소</td>
								<td></td>
