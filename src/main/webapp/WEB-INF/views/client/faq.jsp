                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <p>결제 방법은 신용카드, 적립금 결제 2가지의 방법으로 결제가 가능합니다.</p>
                                    <p>
	                                    1. 신용카드<br/>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="title">[회원정보/멤버십] 회원가입은 어떻게 하냐요?</span><i class="lni lni-plus"></i>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="title">[쿠폰/포인트]현재 제가 가지고 있는 쿠폰 및 포인트는 어디서 확인 가능한가요?</span><i
                                        class="lni lni-plus"></i>
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                    <p>
                                    	현재 고객님이 보유한 포인트는 로그인 후 상단 마이페이지에서 확인 가능합니다.<br/>
										포인트 사용에 대해 어려움이 있거나 더 궁금한 사항이 있으면 고객센터로 문의해주시기바랍니다.<br/> 감사합니다.
									</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="title">[취소/환불]주문취소시 결제한 포인트와 쿠폰은 어떻게 되나요?</span><i
                                        class="lni lni-plus"></i>
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                ...
                                <div class="accordion-body">
                                    <p>
                                    	결제 시 사용하신 포인트는 주문을 취소했을 경우 다시 환원됩니다.<br/>
