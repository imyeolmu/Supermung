...
<main class="board container w-100 p-5">
   <form action='notice-list' method="get" id="moveForm">
	...
	<table class="table">
		<thead>
		<form id="searchForm" method="get" action='client-notice-list'>
         <div class="search">
				...
				<c:forEach items="${list}" var="list">
					<tr class="text-center">
						...
						<td width="100"><nobr /><a class="move link-dark"
							href='/client-notice-detail?nno=<c:out value="${list.nno}"/>'><nobr />
...
// 조회하기
    ...
    $(".move").on("click", function(e){
        ...
        moveForm.attr("action", "/client-notice-detail");
        moveForm.submit();
    });
